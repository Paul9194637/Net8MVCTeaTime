    ...
    public class ProductController : Controller
    {
        ...
        public IActionResult Upsert(ProductVM productVM, IFormFile? file)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                // for Oracle Empty String be NULL, replace (Empty String/NULL) be 1 space, then Trim it after read from DB
                productVM.Product.IMAGEURL = productVM.Product.IMAGEURL ?? " ";
        ...
        { 
            List<Product> objProjectList = _unitOfWork.Product.GetAll(includeProperties:"CATEGORY").ToList();
